...
export default function CartPage() {
  ...
  const handleCheckout = () => {
    ...
    window.open(`https://wa.me/${data.whatsappNumber}?text=${encodeURIComponent(message)}`, '_blank', 'noopener');
  };
    ...
    <div className="cart-page">
      <div className="cart-page-inner">
        <h1 className="cart-page-title">
          🛒 {lang === 'ml' ? 'നിങ്ങളുടെ കാർട്ട്' : 'Your Cart'}
        </h1>
          ...
          <>
                ...
                <div key={item.key} className="cart-item-row">
                  ...
                  <div className="cart-item-info">
                    ...
                    <div className="cart-item-controls">
                      ...
                      <button className="cart-item-remove" onClick={() => removeItem(item.key)} aria-label="Remove">{TRASH_ICON}</button>
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="cart-page-summary">
              <div className="cart-subtotal">
                <span>{lang === 'ml' ? 'ആകെ' : 'Subtotal'} ({totalItems} {totalItems === 1 ? 'item' : 'items'})</span>
