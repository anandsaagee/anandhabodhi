...
const FloatingWhatsApp = () => {
  const storeNumber = '910000000000'; // Placeholder
  const text = 'Hi Anandha Bodhi, I have a question.';
  const url = `https://wa.me/${storeNumber}?text=${encodeURIComponent(text)}`;

  return (
    <a href={url} target="_blank" rel="noopener noreferrer" className="floating-whatsapp" aria-label="Chat with us on WhatsApp">
